...
#define _INTERVAL_SERIAL  1000000 // serial interval (unit: ms)
...
#define _DUTY_MAX 2255 // 2000
#define _DUTY_NEU 1545 // 1500
#define _DUTY_MIN 615 // 1000

#define _SERVO_ANGLE_DIFF  17.9  // Replace with |D - E| degree
#define _SERVO_SPEED       40  // servo speed
...
float volt_to_distance(int a_value)
{
  ...
  return 912 -4.37*a_value + 7.52E-03*pow(a_value,2)-4.54E-06*pow(a_value,3);
}
